...
- [`design/v2_design.md`](design/v2_design.md)：第二版功能语义、事件模型、状态边界和配置草案。
- [`design/v2_implementation_plan.md`](design/v2_implementation_plan.md)：第二版 A12–A18 实施路线与完成标准。
...
- [`acceptance/v2_plan.md`](acceptance/v2_plan.md)：第二版 A12–A18 协作、测试和提交规则。
...
- [`acceptance/A12.md`](acceptance/A12.md)：V1/V2 配置分派、artifact schema、事件契约和 run/v2 manifest 验收。
...
- [`acceptance/A17.md`](acceptance/A17.md)：统一事件仲裁、V2 三表原子发布和交互审计报告验收。
- [`acceptance/A18.md`](acceptance/A18.md)：V2 正式 CLI、四场景代表性真实联网和兼容回归验收。
- [`acceptance/A19.md`](acceptance/A19.md)：V2 可恢复分块工作区、检查点完整性和绝对 RSS 门验收。
- [`acceptance/A20.md`](acceptance/A20.md)：V2 独立时间块 worker、跨块经济状态、宕机恢复和 in-memory 等价验收。
- [`acceptance/A21.md`](acceptance/A21.md)：V2 惰性审计归并、流式指标、有界交互报告和正式原子发布验收。
...
- [`acceptance/A32.md`](acceptance/A32.md)：Fast Matrix 列式经济内核与 Event/V2 等价。
