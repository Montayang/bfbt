...
from bfbt import __version__
from bfbt.showcase.models import ShowcaseSpec
from bfbt.showcase.service import ShowcaseError, inspect_showcase
    ...
    *,
    ...
    checks.append(
        _check(
            ...
            f"bfbt {__version__} is loaded from the selected project"
            if inside_project
            else "bfbt is not loaded from the selected project",
