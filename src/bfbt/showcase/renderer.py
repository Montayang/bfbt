...
<section id="workflow"><div class="section-head"><span class="eyebrow">01 · SYSTEM</span><h2>Agent 控制面，确定性计算内核</h2><p>自然语言负责表达意图；版本化合同和既有引擎负责检查、计算与发布。复杂的路径依赖风险只进入 Event 引擎。</p></div><div class="workflow"><div class="step"><span>快速诊断</span><b>Quick Research</b><span>IC、分层、覆盖率与换手，不模拟账户。</span></div><div class="step"><span>组合研究</span><b>Fast Matrix</b><span>常规截面目标路径的列式经济研究，由用户人工选择。</span></div><div class="step"><span>正式回测</span><b>Event Engine</b><span>时序账户、风险仲裁、滚仓状态、checkpoint 与不可变审计。</span></div></div></section>
