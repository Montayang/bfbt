...
# Immutable v1 Arrow metadata namespace. It predates the BFBT public rename and is part of
# historical DatasetSnapshot and formal-run fingerprints, so changing it would make old evidence
# unverifiable. This is a wire-format identifier, not a Python package compatibility alias.
