...
REPORT_VERSION = "a40-report-v19-localized-public-output"
NA = "暂无 / N/A"
...
<title>bfbt 回测报告 / Backtest Report {html.escape(run_id)}</title>
<style>
...
<header class="report-header"><div><p class="eyebrow">BFBT · {REPORT_VERSION}</p>
...
"""
    ...
    write_html_variants(destination, document)
    return destination
